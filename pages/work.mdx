...
- **Citrix** - Sr. Software Engineer - *as of jun 2019*
  - full-stack engineer on the citrix workspace ui team
  - primarily using typescript, but occasionally c#, c++, objc, and go.
  - consulted with ux and product teams on the ongoing evolution of the product
  - provided deep knowledge of build systems (jenkins, docker, kubernetes) to improve ci/cd processes
  - assisted with go expertise in ongoing stack modernization
  - administered part of a citrix microapps + apps & desktops stack as part of my team's development environment.
  - primarily SAFe-based scrum team 
...
- tools
  ...
  - **gRPC** because rest isn't structured and graphql is too unstructured
