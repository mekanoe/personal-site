...
- https://github.com/roleypoly/roleypoly

a discord bot to help server members assign theirselves roles without using bot commands.

*stack (1.0-2.0): next.js, react, redux (fast-redux), styled-components, flow, koa, eris, postgres*  
*stack (3.0): next.js, react, styled-components, gRPC (+ improbable labs' gRPC-Web), typescript, go, redis, postgres, openfaas, kubernetes, discordgo + lampjaw's discordclient*
